...
public class ObjectMetaSample
{
    ...
    private static final String ak = "NE8CHGQ1IXV3NCYXHGCN";

    private static final String sk = "MxzN6iwbiCQ8RoUmKCeuY4gmNHwxT1IEYmggDn4a";
    
    private static ObsClient obsClient;
    
    private static String bucketName = "my-obs-bucket-demo-cyk-123";
